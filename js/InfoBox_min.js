...
(function() {
	...
	var c = BMapLib.InfoBox = function(f, e, d) {
		...
		this._opts.closeIconUrl = d.closeIconUrl || "http://221.224.13.41:8088/web/images/map_image/close.png";
	...
	c.prototype.getOffset = function() {
		...
		_getCloseIcon: function() {
			...
			var d = "<img src='" + this._opts.closeIconUrl + "' align='right' style='cursor: pointer;margin: 14px;z-index: 3;width: 0;'/>";
